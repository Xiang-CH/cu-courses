    ...
    <div className="flex">
      ...
      <ScrollArea className="w-full h-screen py-2 text-left">
        <div className="w-full h-full py-10 pl-14 text-left">
              ...
              <PopoverContent className="mt-2 w-fit">
                <div className="flex flex-col">
                  <Label className="text-md text-secondary">
                    {t("course-search-filter-faculty")}
                  </Label>
                  ...
                  <Label className="text-md text-secondary mt-2 w-full">
                    {t("course-search-filter-semester")}
                  </Label>
                  ...
                  <Label className="text-md text-secondary mt-2">
                    {t("course-search-filter-class-time")}
                  </Label>
                  <div className="flex ml-2 w-96 my-2 items-center">
                    ...
                    >
                      {t("course-search-filter-class-select-weekday")}
                      <ArrowDownIcon />
                    </Badge>
                    <Badge
                      variant="outline"
                    ...
                    >
                      {t("course-search-filter-class-select-start-time")}
                      <ArrowDownIcon />
                    </Badge>
                    <p>-</p>
                    <Badge
                    ...
                    >
                      {t("course-search-filter-class-select-end-time")}
                      <ArrowDownIcon />
                    </Badge>
                  </div>

                  <Label className="text-md text-secondary mt-2">
                    {t("course-search-filter-workload")}
                  </Label>
                  <div className="flex ml-2 w-96 my-2 items-center">
                    <Badge
                      variant="outline"
                      className="mr-6 my-1 py-2 px-2 rounded-sm w-fit bg-background"
                    >
                      {t("course-search-filter-workload-select")}
                      <ArrowDownIcon />
                    </Badge>
                  </div>

                  <Label className="text-md text-secondary mt-2">
                    {t("course-search-filter-recomendation")}
                  </Label>
                  <div className="flex ml-2 w-96 my-2 items-center">
                    <Badge
                      variant="outline"
                      className="mr-6 my-1 py-2 px-2 rounded-sm w-fit bg-background"
                    >
                      {t("course-search-filter-recomendation-select")}
                      <ArrowDownIcon />
                    </Badge>
                  </div>
                </div>
          ...
          <div className="flex">
            <div className="flex-col mt-10 w-full min-w-[600px] shrink">
              <Input
                placeholder={t("course-search-placeholder")}
                className="w-full bg-muted border-none py-6 px-8"
              />
              <div className="mt-2 w-full bg-primary rounded-lg p-4 overflow-scroll">
